...
from discrete_nn.models.pi_no_bias.discrete_sign import PiNoBiasDiscreteSign
...
class PiNoBiasLogitSign(LogitModel):
    ...
    def generate_discrete_networks(self, method: str) -> PiNoBiasDiscreteSign:
        """
        ...
        discrete_net = PiNoBiasDiscreteSign()
